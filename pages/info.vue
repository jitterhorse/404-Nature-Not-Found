<template>
  <info-layout>
    ...
    <figcaption class="infocaption">Recherche: Das Konzept der Emscherrenaturierung mit Markierungen der Zielsetzungen für vorrangig menschliche (pink) und nichtmenschliche (gelb) Akteure. </figcaption>

    <img class="infoimage" :src=image3>
    <figcaption class="infocaption">Recherche: Begradigungspläne der Emscher von 1789 mit Markierungen des vormals natürlichen Zustand (gelb) und des vom Menschen veränderten Zustand (pink).</figcaption>
...
import image2 from "./assets/img/pink_yellow_intro_1.jpg";
import image3 from "./assets/img/pink_yellow_intro_2.jpg";
